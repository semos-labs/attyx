...
The daemon architecture carries over to Windows. Each shell runs in its own host process connected via named pipes, so the daemon can restart without interrupting running shells. Your sessions survive updates seamlessly.
