...
pub const overlay_ai_stream_format = @import("overlay/ai_stream_format.zig");
...
pub const overlay_ai_fix = @import("overlay/ai_fix.zig");
pub const overlay_ai_redact = @import("overlay/ai_redact.zig");
...
test {
    ...
    _ = @import("overlay/ai_stream_format.zig");
